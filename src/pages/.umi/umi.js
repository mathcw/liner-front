...
import findRoute, {
  getUrlQuery,
} from '/Users/wangcheng/www/liner-front/node_modules/_umi-build-dev@1.18.0@umi-build-dev/lib/findRoute.js';
...
(() => {
  try {
    ...
    // Umi UI Bubble
    require('../../../node_modules/_umi-plugin-ui@1.5.2@umi-plugin-ui/lib/bubble').default(
      {
        port: 3000,
        path: '/Users/wangcheng/www/liner-front',
        currentProject: '',
        isBigfish: undefined,
      },
    );
...
(() => {
  ...
  window.GUmiUIFlag = require('../../../node_modules/_umi-build-dev@1.18.0@umi-build-dev/lib/plugins/commands/block/sdk/flagBabelPlugin/GUmiUIFlag.js').default;
